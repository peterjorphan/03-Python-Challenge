...
with open(output_file, 'w') as textfile:
    ...
    textfile.write(f"Total Profit/Losses: "+str(profitloss)+"\n")
    textfile.write(f"Average Change: {str(avg)}\n")
    textfile.write(f"Greatest Increase in Profits: {maxmonth} (${str(maxchange)})\n")
    textfile.write(f"Greatest Decrease in Profits: {minmonth} (${str(minchange)})\n") 
    textfile.write(f"----------------------------------------------------")
